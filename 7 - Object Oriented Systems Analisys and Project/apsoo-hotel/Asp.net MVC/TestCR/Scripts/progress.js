...
var bar_color = "#fff"; // the progress bar color
var bar_background = "#fff"; // the color of the empty part of bar
var bar_border = "#fff";  // the color of the bar border
var window_background = "#fff"; // the color of the pop-up window
...
function setup_bar()
{
	...
	document.write('<div id="percent" style="position: absolute;'
		+ 'top: ' + 25 + 'px'
		+ ';left: ' + window_width/10 + 'px'
		+ ';width: ' + window_width + 'px'
		+ ';text-align: left'
		+ ';font-weight: bold'
        + ';color: #034af3;'            
		+ ';vertical-align: middle'		
		+ ';font-size: ' + (bar_height-8) + 'px'
		+ ';">');
	document.write('Generating Report '); // Display 0%
...
var image_count = document.getElementsByTagName("div").length;

/* the following variable gets an array of all the images
in the document */
var image_array = document.getElementsByTagName("div");
...
var bar_perc = Math.round(100 / image_count);
    ...
    switch (percent % 4) {
        case 0: message = 'Generating Report ';
            break;
        case 1: message = 'Generating Report . '; 
            break;
        case 2: message = 'Generating Report . . ';
            break;
        case 3: message = 'Generating Report . . .';
            break;
        default: message = 'Generating Report . . . '; 
            break;
    }    
