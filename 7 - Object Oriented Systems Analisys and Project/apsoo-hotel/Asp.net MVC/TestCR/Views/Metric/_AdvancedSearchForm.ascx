<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<MetricSearchForm>" %>
...
<table id="advanced-search-fields">
    ...
    <tr>
        ...
        <td>
            Project<br />
            <%= Html.TextBox("SearchForm.Project", Model.Project, new { @style = "width: 100%"})%>
        </td>
        <td>
            Activity<br />
        ...
        <td>
            ...
            <table id="date-of-creation-range">
                <tr>
                    <td>
                        <%= Html.TextBox("SearchForm.FromDateOfCreation", StringFormatter.FormatInputDate(Model.FromDateOfCreation), new { @style = "width: 100%", @class = "with-date-picker" })%>
                        <%= Html.ValidationMessage("SearchForm.FromDateOfCreation", "Invalid date.")%>
                    </td>
                    <td style="vertical-align: middle">
                        &nbsp;to&nbsp;
                    </td>
                    <td>
                        <%= Html.TextBox("SearchForm.ToDateOfCreation", StringFormatter.FormatInputDate(Model.ToDateOfCreation), new { @style = "width: 100%", @class = "with-date-picker" })%>
                        <%= Html.ValidationMessage("SearchForm.ToDateOfCreation", "Invalid date.")%>
                    </td>
                </tr>
            </table>
        </td>
        <td>
            Last change<br />
            <table id="date-of-last-change-range">
                <tr>
                    <td>
