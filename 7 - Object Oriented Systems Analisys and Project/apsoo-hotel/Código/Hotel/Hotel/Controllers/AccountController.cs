...
namespace Hotel.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void ClientLogOn(string userName, bool rememberMe){
        ...
        public ActionResult LogOn(string userName, string password, bool rememberMe, string returnUrl)
        {
            ...
            else
            {
                ...
                Client cli = cr.SelectWhere(e => e.Login == userName && e.Password == password).FirstOrDefault();
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public bool ValidateUser(string userName, string password)
        {
            ...
            InheritRepository<Client, Person, hotelEntities> cr = new InheritRepository<Client, Person, hotelEntities>();
            Employee emp = er.SelectWhere(e => e.Login == userName && e.Password == password).FirstOrDefault();
            Client cli = cr.SelectWhere(e => e.Login == userName && e.Password == password).FirstOrDefault();
            if (emp != null || cli != null) {                
                return true;
            }
            return false;
        }
