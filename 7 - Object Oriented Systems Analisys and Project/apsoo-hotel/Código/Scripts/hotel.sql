...
INSERT INTO `check` (`id`, `clientid`, `apartmentid`, `datebegin`, `status`, `dateend`, `value`) VALUES 
  (5,38,27,'2010-05-26 10:28:00',0,'2010-05-28 10:28:00',40.000),
  (6,39,28,'2010-05-31 12:00:00',0,'2010-06-01 10:46:00',9.486),
  (8,39,28,'2010-05-28 10:46:00',0,'2010-05-28 10:46:00',0.000);
COMMIT;
...
#
# Data for the `expense` table  (LIMIT 0,500)
#

INSERT INTO `expense` (`id`, `date`, `serviceid`, `checkid`, `value`, `amount`) VALUES 
  (1,'2010-05-26 01:13:00',1,8,0,2),
  (2,'2010-05-26 01:28:00',1,8,0,2);
COMMIT;
