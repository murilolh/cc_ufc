...
void fat_LU(float M[MAX][MAX], float x[], int d, float y[]);//Resolve o sistema por fatoracao LU
void result_inicio(int d, int t, float E, float M[MAX][MAX], float chute[], float lambda);//Gera os resultados iniciais em um arquivo
