...
#include "inverso.h" //Arquivo com funções de leitura e escrita no arquivo, 
#include <stdio.h>   //de manipulacao de vetores e matrizes necessarias para o metodo da potencia inverso
#include <stdlib.h>
#include <cmath>
...
{   
    ...
    do
    {
       ...
       fat_LU(M, x, d, y1);//Acha o vetor y1 atraves de Fatoracao LU
