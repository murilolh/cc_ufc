...
// e usa as funções glPushMatrix() e glPopMatrix() para
// rotacionar, transladar e trocar a escala de três 
...
void Desenha(void)
{
	...
	// Aplica uma rotação ao redor do eixo z 
...
int main(void)
{
	...
	glutCreateWindow("Desenho de vários torus 3D");
